...
import { 
  ...
  AttachMoney as DollarSign, Add as Plus, Delete as Trash2,
...
const VendorsOneOffPaymentsSimple: React.FC = () => {
  ...
  const totalAmount = oneOffPayments.reduce((sum, payment) => sum + payment.amount, 0);
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', mb: 6 }}>
          <Stepper activeStep={1} alternativeLabel sx={{ width: '100%' }}>
            <Step>
              <StepLabel icon={
                <Badge badgeContent={<CheckIcon sx={{ fontSize: '1rem' }} />} color="primary">
            ...
            <Step>
              <StepLabel icon={
                <Avatar sx={{ bgcolor: 'grey.300', width: 32, height: 32, color: 'grey.600' }}>3</Avatar>
              }>
                Review & Submit
              </StepLabel>
            </Step>
        ...
        <Paper elevation={2} sx={{ mb: 4 }}>
          <Box sx={{ p: 3, borderBottom: 1, borderColor: 'divider' }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
              Add vendor payments or one-time payments to include in this payroll run
            </Typography>
          </Box>
          ...
          <Box sx={{ p: 4 }}>
                    ...
                    <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          onChange={(e: SelectChangeEvent) => setSelectedVendor(e.target.value)}
                          label="Vendor *"
                          required
                        >
                    ...
                    <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
                      ...
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          id="codeClass"
                          value={codeClass}
                          onChange={(e: SelectChangeEvent) => setCodeClass(e.target.value)}
                          label="Code/Class"
                        >
                  ...
                  <form onSubmit={handleQuickAdd}>
                    <Stack spacing={3} sx={{ mb: 3 }}>
                      ...
                      <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
                        ...
                        <FormControl fullWidth>
                          <InputLabel id="quickPaymentMethod-label">Payment Method</InputLabel>
                          <Select
            ...
            <Box>
              ...
              {oneOffPayments.length > 0 ? (
                    ...
                    <TableBody>
                      {oneOffPayments.map((payment) => (
                        <TableRow key={payment.id}>
                          ...
                          <TableCell>
                            {payment.paymentMethod === 'check' ? 'Check' : 'ACH'}
                          </TableCell>
                ...
                <Paper variant="outlined" sx={{ textAlign: 'center', py: 4, bgcolor: 'grey.50' }}>
                  <Typography color="text.secondary">
                    No one-off payments added yet. Use the forms above to add payments.
                  </Typography>
                </Paper>
              )}
            </Box>
