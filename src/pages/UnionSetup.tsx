...
import { 
  ChevronLeft, Save, Info as InfoIcon, ArrowRight, Users, 
...
const UnionSetup: React.FC = () => {
  const [hasUnionProduction, setHasUnionProduction] = useState<boolean | null>(null);
  ...
  const handleUnionToggle = (hasUnion: boolean) => {
    ...
    if (!hasUnion) {
      ...
      const { union, agreementType, productionType, tier, aeaEmployerId, aeaProductionTitle, aeaBusinessRep, ...otherErrors } = errors;
  ...
  const validateForm = (): boolean => {
    ...
    if (hasUnionProduction) {
      ...
      if (formData.agreementType === 'off_broadway' && !formData.productionType) {
  ...
  return (
    <Box sx={{ backgroundColor: 'grey.50', minHeight: '100vh' }}>
      <Paper elevation={3} sx={{ mb: 2 }}>
        <Box sx={{ maxWidth: 'lg', mx: 'auto', px: { xs: 2, sm: 3, md: 4 }, py: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <Box sx={{ maxWidth: 'md', mx: 'auto', px: { xs: 2, sm: 3, md: 4 }, py: 4 }}>
        <Box mb={3}>
          <Button 
              ...
              <Stack spacing={4}>
                ...
                <Box>
                  ...
                  <Stack direction="row" spacing={2}>
                    <Button
                      variant={hasUnionProduction === true ? 'contained' : 'outlined'}
                    ...
                    <Button
                      variant={hasUnionProduction === false ? 'contained' : 'outlined'}
                ...
                {hasUnionProduction && (
                  <Paper elevation={0} sx={{ backgroundColor: 'grey.50', p: 3, borderRadius: 1 }}>
                    <Box 
                      display="flex" 
                    ...
                    >
                      ...
                      <IconButton size="small">
                        {showUnionSection ? <ChevronUp size={20} /> : <ChevronDown size={20} />}
                      </IconButton>
                    </Box>
                    ...
                    {showUnionSection && (
                      <Stack spacing={3} mt={2}>
                        <FormControl fullWidth error={!!errors.union}>
                          ...
                          {errors.union && (
                            <FormHelperText error>{errors.union}</FormHelperText>
                          )}
                        </FormControl>
                        ...
                        {isOffBroadway && (
                          <FormControl fullWidth error={!!errors.productionType}>
                            <InputLabel id="productionType-label">
                              Musical/Dramatic <span style={{ color: 'red' }}>*</span>
                            </InputLabel>
                            <Select
                            ...
                            >
                              <MenuItem value="">-- Select Production Type --</MenuItem>
                            ...
                            {errors.productionType && (
                              <FormHelperText error>{errors.productionType}</FormHelperText>
                            )}
                          </FormControl>
                        )}
                        ...
                        {isDevelopmental && (
                          <FormControl fullWidth error={!!errors.tier}>
                            ...
                            {errors.tier && (
                              <FormHelperText error>{errors.tier}</FormHelperText>
                            )}
                          </FormControl>
                        )}
                        ...
                        {!is29HourReading && (
                          <>
                            <TextField
                              label={
                                <>
                                  AEA Employer ID <span style={{ color: 'red' }}>*</span>
                                </>
                              }
                              id="aeaEmployerId"
                              name="aeaEmployerId"
                            ...
                            <TextField
                              label={
                                <>
                                  AEA Production Title <span style={{ color: 'red' }}>*</span>
                                </>
                              }
                            ...
                            <TextField
                              label={
                                <>
                                  AEA Business Representative <span style={{ color: 'red' }}>*</span>
                                </>
                              }
                              id="aeaBusinessRep"
                              name="aeaBusinessRep"
                              ...
                              helperText={
                                errors.aeaBusinessRep ? (
                                  ...
                                  <Typography variant="caption">
                                    Your assigned AEA business representative's name
                                  </Typography>
                                )
                              }
                              fullWidth
