...
import { AlertCircle, ChevronRight, ChevronLeft, Info } from 'lucide-react';
...
const AdminUserDetails: React.FC = () => {
  ...
  const isFormValid = () => {
    return (
      ...
      (formData.role !== 'custom' || (formData.role === 'custom' && customRoleText.trim())) &&
      Object.keys(errors).length === 0
    );
  };

  return (
    <Box maxWidth="600px" mx="auto" p={4} bgcolor="white" borderRadius={2} boxShadow={3}>
      <Stack spacing={2} mb={4}>
        <Typography variant="h5" fontWeight="bold">Registration</Typography>
        <Typography color="text.secondary">Step 2 of 4: Admin User Details</Typography>
        ...
        <Stack spacing={3}>
          ...
          <FormControl fullWidth error={Boolean(errors.email)}>
            <InputLabel htmlFor="email">
              Email Address
              <Tooltip title="This email will be used for login and system notifications" placement="top" arrow>
